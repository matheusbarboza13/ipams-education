...
const styles = {
    header: {
        ...
        top: 0,
        zIndex: 20,
        background: "linear-gradient(180deg, rgba(30, 79, 214, 0.20), rgba(30, 79, 214, 0.10))",
        backdropFilter: "blur(10px)",
        borderBottom: "1px solid rgba(30, 79, 214, 0.16)",
    },
    ...
    logoWrap: {
        ...
        borderRadius: "50%",
        overflow: "hidden",
        border: "2px solid rgba(30, 79, 214, 0.55)",   // 🔵 borda azul
        background: "rgba(255, 255, 255, 0.92)",
        boxShadow: "0 10px 22px rgba(30, 79, 214, 0.18)", // glow leve (opcional)
        display: "flex",
        alignItems: "center",
    ...
    dropdownItemActive: {
        background: "rgba(30, 79, 214, 0.10)",
    },
